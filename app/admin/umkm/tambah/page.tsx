...
const fields = [
  ...
  ["keunggulan2", "Keunggulan Produk 2", "text"], ["keunggulan3", "Keunggulan Produk 3", "text"], ["keunggulan4", "Keunggulan Produk 4", "text"], ["password", "Password", "password"],
] as const;

const uploads = ["Logo UMKM", "Gambar UMKM 1", "Gambar UMKM 2", "Gambar UMKM 3", "Gambar UMKM 4", "Gambar UMKM 5"];
