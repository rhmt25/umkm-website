    ...
    <main className="flex min-h-[calc(100vh-5rem)] items-center justify-center bg-color2/40 px-4 py-12 sm:px-6">
      <section className="w-full max-w-md overflow-hidden rounded-3xl border border-color4/80 bg-color3 shadow-xl shadow-color5/10">
        ...
        <form action={formAction} className="space-y-5 p-7 sm:p-10">
          <label className="block"><span className="mb-2 block text-sm font-semibold">Nomor HP atau Username</span><div className="relative"><Phone className="absolute left-4 top-1/2 -translate-y-1/2 text-color5/45" size={19} /><input type="text" name="identity" autoComplete="username" placeholder="Contoh: 0812-3456-7890 atau admin" required className="h-12 w-full rounded-xl border border-color4 bg-color3 pl-11 pr-4 outline-none transition focus:border-color1 focus:ring-2 focus:ring-color1/15" /></div></label>
